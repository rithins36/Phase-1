	...
	<body>
		<div class="sticky">
			...
			?>
				...
				<h1>
				<a class="navbar-brand " href="#">Chat_Care </a>
				</h1>
			...
			{
			?>
				<nav class="navbar navbar-expand-lg navbar-dark fixed-top px-5 justify-content-center" style="background-color: rgba(0,0,0,0.5)">
				<a class="navbar-brand justify-content-end " style="position:relative;left:3em;margin-left:270px;font-size:32px;font-family:serif" href="index.php">Chat_Care</a>
				<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
					<span class="navbar-toggler-icon"></span>
				</button>
