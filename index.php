...
<div class="container-fluid p-0">
	<div class="col-md-12 p-0 bg-img">
		<!-- <img src="images/bg-img.jpeg" class="img-fluid " /> -->
	</div>
	<div id="about" class="col-md-12 pt-4 pb-4 mt-4">
		<div class="col-md-8 mx-auto mt-2 text-center pt-4 pb-4">
	...
	<div id="u_login" class="col-md-12 py-1 bgsection">
	...
	<div id="a_login" class="col-md-12 bg-white py-1">
	...
	<div id="contact" class="col-md-12 pt-4 pb-4 bgsection">
		<div class="col-md-8 mx-auto mt-4 text-center pt-4 pb-4">
			...
			<p class="mt-4 text-white">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
		</div>
	</div>
	</div>
</div>
